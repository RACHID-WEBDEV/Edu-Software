  ...
  <div class="content-wrapper">
					...
					<div class="box bg-info bg-img" style="background-image: url(../images/gallery/bg-1.png)">
						<div class="box-body text-center">							
							...
							<div class="max-w-500 mx-auto">
								<h2 class="text-white mb-20 font-weight-500">Best Employee Rasheed,</h2>
	...
	<div class="box-body">							
		...
		<div>
			...
			<h3 class="text-white mb-0 font-weight-500">3400 <small class="text-success"><i class="fa fa-caret-up"></i> +3.5%</small></h3>
		</div>
	</div>
</div>
</div>
