...
<html lang="zxx">
    <head>
        ...
        <link rel="stylesheet" href="frontend/css/imagelightbox.min.css" />
    ...
    <body>
            ...
            <div class="main-responsive-nav">
                <div class="container">
                    <div class="main-responsive-menu">
                        <div class="logo">
                            <a href="index.html">
                                <img src="frontend/img/roateklogo.png" alt="image" />
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            ...
                            <div class="others-options d-flex align-items-center">
                                ...
                                <div class="option-item">
                                    @auth
                                    <a href="{{ url('/dashboard') }}" class="default-btn">Dashboard</a>
                                    @else
                                    ...
                                    <div class="dropdown language-switcher d-inline-block">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="frontend/img/english.png" class="shadow-sm" alt="flag" />
                                                <span>English</span>
                                            </a>
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="frontend/img/arab.png" class="shadow-sm" alt="flag" />
                                                <span>العربيّة</span>
                                            </a>
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="frontend/img/germany.png" class="shadow-sm" alt="flag" />
                                                <span>Deutsch</span>
                                            </a>
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="frontend/img/portugal.png" class="shadow-sm" alt="flag" />
                                                <span>Português</span>
                                            </a>
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="frontend/img/china.png" class="shadow-sm" alt="flag" />
                                                <span>简体中文</span>
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="main-banner">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="main-banner-content">
                                        <h1>Online Education Courses For Everyone</h1>
                                ...
                                <div class="col-lg-6">
                                    <div class="main-banner-image-wrap">
                                        <img src="frontend/img/main-banner/main-banner-2.png" alt="image" />
                                        <div class="banner-image-wrap-shape">
                                            <img src="frontend/img/main-banner/main-banner-shape-2.png" alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="main-banner-shape">
                <div class="banner-bg-shape">
                    <img src="frontend/img/main-banner/banner-bg-shape-1.png" alt="image" />
                </div>
                <div class="banner-bg-shape-2">
                    <img src="frontend/img/main-banner/banner-bg-shape-2.png" alt="image" />
                </div>
            </div>
        </div>
        ...
        <div class="support-area pt-100 pb-70">
            <div class="container">
                <ul class="support-list-item">
                    <li>
                        <img src="frontend/img/support/support-1.png" alt="image" />
                        <span>Great Teacher</span>
                    </li>
                    <li>
                        <img src="frontend/img/support/support-2.png" alt="image" />
                        <span>Online Courses</span>
                    </li>
                    <li>
                        <img src="frontend/img/support/support-3.png" alt="image" />
                        <span>Super Fast Support</span>
                    </li>
                    <li>
                        <img src="frontend/img/support/support-4.png" alt="image" />
                        <span>Best Simulation</span>
                    </li>
                    <li>
                        <img src="frontend/img/support/support-5.png" alt="image" />
        ...
        <section class="class-area bg-fdf6ed pt-100 pb-70">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-class">
                            <div class="class-image">
                                <a href="#">
                                    <img src="frontend/img/class/class-3.jpg" alt="image" />
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-class">
                            <div class="class-image">
                                <a href="#">
                                    <img src="frontend/img/class/class-4.jpg" alt="image" />
                                </a>
                            </div>
                            <div class="class-content">
                    ...
                    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                        <div class="single-class">
                            <div class="class-image">
                                <a href="#">
                                    <img src="frontend/img/class/class-5.jpg" alt="image" />
                                </a>
                            </div>
                            <div class="class-content">
            ...
            <div class="class-shape">
                <div class="shape-1">
                    <img src="frontend/img/class/class-shape-1.png" alt="image" />
                </div>
                <div class="shape-2">
                    <img src="frontend/img/class/class-shape-2.png" alt="image" />
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-teacher-item">
                            <div class="image">
                                <img src="frontend/img/teacher/teacher-8.jpg" alt="image" />
                                <div class="content">
                                    <h3>Glims Bond</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-teacher-item">
                            <div class="image">
                                <img src="frontend/img/teacher/teacher-9.jpg" alt="image" />
                                <div class="content">
                                    <h3>Sherlock Bin</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-teacher-item">
                            <div class="image">
                                <img src="frontend/img/teacher/teacher-10.jpg" alt="image" />
                                <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-teacher-item">
                            <div class="image">
                                <img src="frontend/img/teacher/teacher-11.jpg" alt="image" />
                                <div class="content">
                                    <h3>Smith Broke</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-teacher-item">
                            <div class="image">
                                <img src="frontend/img/teacher/teacher-12.jpg" alt="image" />
                                <div class="content">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <div class="event-image">
                                        <a href="#"><img src="frontend/img/event/event-5.png" alt="image" /></a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="col-lg-6">
                        <div class="event-box-item">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <div class="event-image">
                                        <a href="#"><img src="frontend/img/event/event-6.png" alt="image" /></a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="event-content">
                    ...
                    <div class="col-lg-6">
                        <div class="event-box-item">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <div class="event-image">
                                        <a href="#"><img src="frontend/img/event/event-7.png" alt="image" /></a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="event-content">
                    ...
                    <div class="col-lg-6">
                        <div class="event-box-item">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <div class="event-image">
                                        <a href="#"><img src="frontend/img/event/event-8.png" alt="image" /></a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="event-content">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="choose-image">
                            <img src="frontend/img/choose/choose-1.png" alt="image" />
                            <div class="choose-image-shape">
                                <div class="shape-1">
                                    <img src="frontend/img/choose/choose-shape-1.png" alt="image" />
                                </div>
                                <div class="shape-2">
                                    <img src="frontend/img/choose/choose-shape-2.png" alt="image" />
                                </div>
                                <div class="shape-3">
                                    <img src="frontend/img/choose/choose-shape-3.png" alt="image" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item">
                            <div class="blog-image">
                                <a href="#">
                                    <img src="frontend/img/blog/blog-1.jpg" alt="image" />
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item">
                            <div class="blog-image">
                                <a href="#">
                                    <img src="frontend/img/blog/blog-2.jpg" alt="image" />
                                </a>
                            </div>
                            <div class="blog-content">
                                <ul class="post-meta">
                    ...
                    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                        <div class="single-blog-item">
                            <div class="blog-image">
                                <a href="#">
                                    <img src="frontend/img/blog/blog-3.jpg" alt="image" />
                                </a>
                            </div>
                            <div class="blog-content">
                                <ul class="post-meta">
        ...
        <div class="newsletter-area ptb-100">
            ...
            <div class="newsletter-shape">
                <div class="shape-1">
                    <img src="frontend/img/newsletter/newsletter-shape-1.png" alt="image" />
                </div>
                <div class="shape-2">
                    <img src="frontend/img/newsletter/newsletter-shape-2.png" alt="image" />
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="partner-slider owl-carousel owl-theme">
                    <div class="partner-item">
                        <img src="frontend/img/partner/partner-1.png" alt="image" />
                    </div>
                    <div class="partner-item">
                        <img src="frontend/img/partner/partner-2.png" alt="image" />
                    </div>
                    <div class="partner-item">
                        <img src="frontend/img/partner/partner-3.png" alt="image" />
                    </div>
                    <div class="partner-item">
                        <img src="frontend/img/partner/partner-4.png" alt="image" />
                    </div>
                    <div class="partner-item">
                        <img src="frontend/img/partner/partner-5.png" alt="image" />
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-contact-info">
                                ...
                                <li>
                                    ...
                                    <span>Email</span>
                                    <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#bcd4d9d0d0d3fcd7d9c8ddd292dfd3d1">
                                        <span class="__cf_email__" data-cfemail="93fbf6fffffcd3f8f6e7f2fdbdf0fcfe">[email&#160;protected]</span>
                                    </a>
                                </li>
                                <li>
                                    <i class="bx bx-map"></i>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="photo-gallery-list">
                                <li>
                                    <div class="box">
                                        <img src="frontend/img/footer-gallery/footer-gallery-1.jpg" alt="image" />
                                        <a href="#" target="_blank" class="link-btn"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="box">
                                        <img src="frontend/img/footer-gallery/footer-gallery-2.jpg" alt="image" />
                                        <a href="#" target="_blank" class="link-btn"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="box">
                                        <img src="frontend/img/footer-gallery/footer-gallery-3.jpg" alt="image" />
                                        <a href="#" target="_blank" class="link-btn"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="box">
                                        <img src="frontend/img/footer-gallery/footer-gallery-4.jpg" alt="image" />
                                        <a href="#" target="_blank" class="link-btn"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="box">
                                        <img src="frontend/img/footer-gallery/footer-gallery-5.jpg" alt="image" />
                                        <a href="#" target="_blank" class="link-btn"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="box">
                                        <img src="frontend/img/footer-gallery/footer-gallery-6.jpg" alt="image" />
                                        <a href="#" target="_blank" class="link-btn"></a>
                                    </div>
                                </li>
                                <li>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="copyright-area-content">
                    <p>
                        Copyright © 2021 Roatek . All Rights Reserved by
                        <a href="https://roatek.com.ng/" target="_blank">
                            Roatek Technologies
                        </a>
                    </p>
                </div>
        ...
        <script src="frontend/js/imagelightbox.min.js"></script>
