...
class StudentRegController extends Controller
{
 ...
 public function StudentUpdatePromotion(Request $request,$student_id){
	...
	public function ViewStudentRegDetails($student_id){
		
		$data['singleData'] = AssignStudent::all();
		$data['studentdetails'] = AssignStudent::with(['student','discount'])->where('student_id',$student_id)->first();
